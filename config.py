...
class Config:
    ...
    DB_USER_PASSWD = JsonConfig.get_data('DB_USER_PASSWD', 'capstone1234')
    DB_HOST = JsonConfig.get_data('DB_HOST', 'capstone2-springboot-db.cewijb8a67nv.ap-northeast-2.rds.amazonaws.com')
