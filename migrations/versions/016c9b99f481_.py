...
Revision ID: 016c9b99f481
Revises: 
Create Date: 2021-10-28 18:30:29.078750
...
def upgrade():
    ...
    sa.Column('rbbb', sa.Boolean(), nullable=True),
    sa.Column('lbbb', sa.Boolean(), nullable=True),
